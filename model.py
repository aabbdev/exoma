...
class TransformerBlock(nn.Module):
    def __init__(self, layer_id: int, args: ModelArgs):
        ...
        self.feed_forward = FFF(dim=args.dim, depth=args.deph, parallel_size=args.parallel_size)
...
if __name__ == "__main__":
    model = Transformer(ModelArgs(vocab_size=259))
    ...
    model.eval()
    start = time.time()
    output = model(torch.randint(0, 259, (1, 2048)), 0)
